...
function updateDimensions() {
    ...
    if (document.getElementById("eternityupgrades").style.display == "block" && document.getElementById("eternitystore").style.display == "block") {
		...
		document.getElementById("eter7").innerHTML = "Dilated time gain is boosted by antimatter<br>Currently: "+(1 + Math.log10(Math.max(1, player.money.log10())) / 40)+"x<br>Cost: "+shortenCosts(new Decimal("1e700000"))+" EP"
        document.getElementById("eter8").innerHTML = "Dilated time gain is boosted by infinity points<br>Currently: "+(1 + Math.log10(Math.max(1, player.infinityPoints.log10())) / 20)+"x<br>Cost: "+shortenCosts(new Decimal("1e700000"))+" EP"
        document.getElementById("eter9").innerHTML = "Dilated time gain is boosted by eternity points<br>Currently: "+(1 + Math.log10(Math.max(1, player.eternityPoints.log10())) / 10)+"x<br>Cost: "+shortenCosts(new Decimal("1e700000"))+" EP"
