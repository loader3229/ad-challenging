...
function getECGoal(name,completed){
	...
	if(name=="eterc11"&&completed<10)return Decimal.mul("1e150000",Decimal.pow("1e60000",completed-5));
	if(name=="eterc11"&&completed<15)return Decimal.mul("1e450000",Decimal.pow("1e387500",completed-10));
	...
	if(name=="eterc12"&&completed==5)return new Decimal("1e200000000");
	if(name=="eterc12"&&completed==6)return new Decimal("1e220000000");
