...
function drawStudyTree() {
	...
	drawTreeBranch("1007", "tba5")
	drawTreeBranch("tba4", "tba6")
	drawTreeBranch("tba5", "tba7")
	drawTreeBranch("tba6", "tba8")
	drawTreeBranch("1007", "tba9")
	drawTreeBranch("tba7", "tba10")
	drawTreeBranch("tba9", "tba10")
	drawTreeBranch("tba4", "tba11")
	drawTreeBranch("tba8", "tba12")
	drawTreeBranch("tba11", "tba12")
    drawTreeBranch("dilstudy1", "dilstudy2")
	drawTreeBranch("dilstudy2", "1003")
    drawTreeBranch("dilstudy2", "dilstudy3")
	drawTreeBranch("dilstudy3", "tba4")
    drawTreeBranch("dilstudy3", "dilstudy4")
	drawTreeBranch("dilstudy4", "tba5")
